  ...
  <!-- <div class="row mt-3"> -->
    ...
    <div class="col-md-8">
      <div class="card shadow-lg">
        <div class=" col bg-primary text-center"><h1 class="text-white"> Credit Institute B.Com 3 <sup>rd</sup> Class Student Attendence Details</h1>
        </div>
      ...
      <input type="submit"  class="form-control btn bg-primary" name="submit" value="Show Attendence"> 
        ...
        <div class="card-body mx-auto">
          <p class="card-text">
           ...
           $sql = "SELECT * FROM `class_b3`,`attend_b3` WHERE reg='$roll' AND roll='$roll' AND month='$month'";
