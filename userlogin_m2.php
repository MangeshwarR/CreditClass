...
<div class="container">
  ...
  <div class="col-md-6 mb-2 col-7 mr-2">
    ...
    <a href="pass_m2.php"><input type="button"  class="form-control btn bg-success" value="Forget Password"></a>
</div>
</div> 
...
<?php
    if(isset($_POST['login']))
    {
      ...
      else
      {
        $name =  $_POST['name'];
        $pass = $_POST['pass'];
          $sql = "SELECT * FROM class_m2 WHERE cname = '$name' AND pass= '$pass'";
       ...
       ?>
       <script>
         window.open('studentlogin_m2.php?id=<?php echo $data["reg"];?>','_self');
       </script>
      <?php
