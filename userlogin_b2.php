...
<div class="container">
  ...
  <div class="col-md-6 mb-2 col-7 mr-2">
    ...
    <a href="pass_b2.php"><input type="button"  class="form-control btn bg-success" value="Forget Password"></a>
</div>
</div> 
...
<?php
    if(isset($_POST['login']))
    {
      ...
      else
      {
        $name =  $_POST['name'];
        $pass = $_POST['pass'];
          $sql = "SELECT * FROM class_b2 WHERE cname = '$name' AND pass= '$pass'";
       ...
       ?>
       <script>
         window.open('studentlogin_b2.php?id=<?php echo $data["reg"];?>','_self');
       </script>
      <?php
