      ...
      <div class="card shadow-lg">
        ...
        <div class="card-header">
          ...
          <div class="form-group">
              <label for="fathern"><i class="fas fa-lock"></i>&nbsp;&nbsp;New Password</label>
               <div class="input-group-prepend">
                 <input type="password" class="form-control" id="fathern" name="pass" value="<?php echo $data['pass']; ?>" required="required">
              </div>
          </div>
          <div class="form-group">
              <label for="fathern"><i class="fas fa-lock"></i>&nbsp;&nbsp;Confirm Password</label>
               <div class="input-group-prepend">
...
if ($pass == $pass1)
  {
      ...
      <?php
      include 'conection.php';
    $sql = "UPDATE `class_11` SET `pass`='$pass', `pass`='$pass1' WHERE `email`='$email'";
     $run = mysqli_query($conn,$sql);
      if($run == true)
       { 
