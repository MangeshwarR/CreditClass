	...
	<div class="row">
		...
		<div class="col-md-8">
			<div class="card shadow-lg">
				<form class="form-group" action="feepayform.php" method="post" enctype="multipart/form-data">
...
$query ="INSERT INTO `fees_11`(`roll`, `name`, `month`, `dt`, `paid`, `dcount`, `unpaid`, `echarge`) VALUES ('$roll','$name','$month','$dt','$paid','$dcount','$unpaid','$echarge')";
