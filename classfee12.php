...
<body>
	...
	<div class="row mt-5 mb-5">
		<div class="col shadow-lg">
			 <div class="row mb-3">
			 	<div class=" col bg-danger text-center"><h1 class="text-white"> Credit Institute 12 <sup>th</sup> Class Student Detail</h1>
			 	<a href="feepayform12.php" class="btṇ bg-primary text-white ml-7 p-3 rounded-circle">Add New Student Fees</a>
			 </div>
			 </div>
 	...
 	<tr>
 	    ...
 	    <td>2020<a href="feepayformedit12.php?roll=<?php echo $data['roll'];?>" class="btṇ bg-primary text-white ml-4 p-1 rounded-circle">Edit</a></td>
 	</tr>
<?php
}
?>
