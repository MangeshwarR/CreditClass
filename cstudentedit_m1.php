...
include 'conection.php';
       $reg= $_SESSION["userreg"];    
        ...
        $sql1 = "SELECT * FROM class_m1 WHERE adhar = $adhar";
        ...
        if(mysqli_num_rows($run1) > 0)
        {
          echo '<div class="alert alert-danger">This student record already exist Please check class table & retry again.</div>';
           echo '<div><a href="cstudentedit_m1.php" class="btn btn-primary "> Back</a></div>';
                   
        }
    else
    {
      $sql2 = "INSERT INTO  `class_m1` SELECT * FROM `addmision` WHERE  reg='$reg'";
   ...
   <a href="cstudentedit1_m1.php" class="btn btn-primary mx-auto">Add</a>
