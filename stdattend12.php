  ...
  <!-- <div class="row mt-3"> -->
    ...
    <div class="col-md-8">
      <div class="card shadow-lg">
        <div class=" col bg-primary text-center"><h1 class="text-white"> Credit Institute 12 <sup>th</sup> Class Student Attendence Details</h1>
        </div>
      ...
      <input type="submit"  class="form-control btn bg-primary" name="submit" value="Show Attendence"> 
        ...
        <div class="card-body mx-auto">
          <p class="card-text">
           ...
           $sql = "SELECT * FROM `class_12`,`attend_12` WHERE reg='$roll' AND roll='$roll' AND month='$month'";
