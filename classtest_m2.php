...
<body>
	...
	<div class="row mt-5 mb-5">
		<div class="col shadow-lg">
			 <div class="row mb-3">
			 	<div class=" col bg-danger text-center"><h1 class="text-white"> Credit Institute M.Com 2 <sup>nd</sup> Class Student Test Detail</h1>
			 		<a href="test_m2.php" class="btṇ bg-primary text-white ml-4 p-3 rounded-circle">Add Student Result </a></div>
			 </div>
			 <?php
