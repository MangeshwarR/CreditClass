  ...
  <!-- <div class="row mt-3"> -->
    ...
    <div class="col-md-8">
      <div class="card shadow-lg">
        <div class=" col bg-primary text-center"><h1 class="text-white"> Credit Institute B.Com <sup>st</sup> Class Student Attendence Details</h1>
        </div>
      ...
      <input type="submit"  class="form-control btn bg-primary" name="submit" value="Show Attendence"> 
        ...
        <div class="card-body mx-auto">
          <p class="card-text">
           ...
           $sql = "SELECT * FROM `class_b1`,`attend_b1` WHERE reg='$roll' AND roll='$roll' AND month='$month'";
