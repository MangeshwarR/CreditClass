    ...
    <div class="col-md-8">
      <div class="card shadow-lg">
        <form class="form-group" action="" method="post" enctype="multipart/form-data">
          <div class=" col bg-primary text-center"><h1 class="text-white"> Credit Institute B.Com 1 <sup>st</sup> Class Student Attendence Details</h1>
        </div>
...
$query ="INSERT INTO `attend_b1`(`roll`, `month`, `dt`, `attend`) VALUES ('$roll','$month','$dt','$attend')";
