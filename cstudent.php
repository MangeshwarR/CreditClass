...
<body>
	...
	<div class="row mt-3 mb-5">
			 	<div class=" col bg-danger text-center fixed-top "><h1 class="text-white"> Credit Institute 11 <sup>th</sup> Class Student Detail</h1><a href="cstudentedit.php" class="btṇ bg-primary text-white ml-7 p-3 rounded-circle">Add New Student</a></div>
 	...
 	<tr>
		<td colspan="2"><?php echo $data['reg'];?><a href="cstudentedit2.php?id=<?php echo $data['reg'];?>" class="btṇ bg-primary text-white ml-4 p-1 rounded-circle">Edit</a><a href="cstudentdelete.php?reg=<?php echo $data['reg'];?>" class="btṇ bg-danger text-white ml-4 p-1 rounded-circle">Delete</a> </td>	 
