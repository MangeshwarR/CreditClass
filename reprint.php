...
<div class="container">
  <div class="row mt-3">
    ...
    <div class="col-md-5">
      <div class="card shadow-lg">
        ...
        <div class="ml-2"><small>Reprint Registration Form</small></div>
        </div>
        </div>
      </div>
        <div class="card-body ">
  ...
  <div class="col-md-6 mb-2 col-7 mr-2">
    ...
    <a href="reprint1.php"><input type="button"  class="form-control btn bg-success" value="Forget Password"></a>
</div>
</div> 
...
<?php
    if(isset($_POST['submit']))
    {
      ...
      else
      {
       ...
       ?>
       <script>
         window.open('add1.php?id=<?php echo $data["reg"];?>','_self');
       </script>
      <?php
