	...
	<div class="row">
		...
		<div class="col-md-8">
			<div class="card shadow-lg">
				<form class="form-group" action="test_b1.php" method="post" enctype="multipart/form-data">
					<div class=" col bg-primary text-center"><h1 class="text-white"> Credit Institute B.Com 1<sup>st</sup> Class Student Test Details</h1>
        </div>
...
$query ="INSERT INTO `test_b1`(`roll`, `name`, `dt`, `attend`, `subj`, `obmark`, `tomark`, `result`) VALUES ('$roll','$name','$dt','$attend','$subj','$obmark','$tomark','$result')";
...
if($run == TRUE)
 {
 	...
 	$roll=$_POST['roll'];
 	include 'conection.php';
$query = "SELECT * FROM `test_b1` WHERE roll='$roll'";
$run = mysqli_query($conn,$query);
