...
<div class="container">
        ...
        <div class="card-header">
           ...
           <div class="form-group">
              <label for="fathern">Description</label>
               <div class="input-group-prepend">
                 <textarea class="form-control" id="fathern" name="desc" required="required" cols="12" rows="9"></textarea> 
              </div>
          </div>
 ...
 if (isset($_POST['submit'])) 
 {
  ...
  $ttl=$_POST['ttl'];
  $desc=$_POST['desc'];
  $sql="INSERT INTO `news1`( `tl1`, `des1`) VALUES ('$ttl','$desc')";
  // "INSERT INTO `news1`(`tl`,`des`,) VALUES ('$ttl','$desc')";
