...
$sql = "SELECT * FROM `class_m1` WHERE reg='$id'";
...
<div class="container    mt-4 pb-2 overflow-auto">
	...
	<div class="row ">
			<div class="col-md-4 mx-auto">
			   <h3><a href='fees_m1.php' class="ml-5 btn btn-primary text-white">Fees Detail</a></h3>
			 </div>
			 <div class="col-md-4 mx-auto">
			 	<h3><a href='stdattend_m1.php' class="ml-5 btn btn-primary text-white">Attandence Detail</a></h3>
			 	 </div>
			 <div class="col-md-4 mx-auto">
			 	<h3><a href='stdtest_m1.php' class="ml-5 btn btn-primary text-white">Test Detail</a></h3>
			 </div>
	</div>
	<div class="row ">
		<div class="col-12 mx-auto">
