...
<body>
	...
	<div class="row mt-5 mb-5">
		<div class="col shadow-lg">
			 <div class="row mb-3">
			 	<div class=" col bg-danger text-center"><h1 class="text-white"> Credit Institute B.Com 2 <sup>nd</sup> Class Student Detail</h1>
			 	<a href="feepayform_b2.php" class="btṇ bg-primary text-white ml-7 p-3 rounded-circle">Add New Student Fees</a>
			 </div>
			 </div>
 	...
 	<tr>
 	    ...
 	    <td>2020<a href="feepayformedit_b2.php?roll=<?php echo $data['roll'];?>" class="btṇ bg-primary text-white ml-4 p-1 rounded-circle">Edit</a></td>
 	</tr>
<?php
}
?>
