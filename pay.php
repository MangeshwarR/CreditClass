	...
	<div class="row">
		...
		<div class="col-md-8">
			<div class="card shadow-lg">
				<form class="form-group" action="pay.php" method="post" enctype="multipart/form-data">
					<div class=" col bg-primary text-center"><h1 class="text-white"> Credit Institute 11 <sup>th</sup> Class Student Fees Details</h1>
        </div>
...
$a = ($unpaid+$echarge)+(-$paid-$dcount);

include 'conection.php';

$query ="INSERT INTO `fees_11`(`roll`, `name`, `month`, `dt`, `paid`, `dcount`, `unpaid`, `echarge`) VALUES ('$roll','$name','$month','$dt','$paid','$dcount','$a','$echarge')";
...
if($run == TRUE)
 {
 	...
 	$roll=$_POST['roll'];
 	include 'conection.php';
$query = "SELECT * FROM `fees_11` WHERE roll='$roll'";
$run = mysqli_query($conn,$query);
