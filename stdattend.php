  ...
  <!-- <div class="row mt-3"> -->
    ...
    <div class="col-md-8 mx-auto">
      <div class="card shadow-lg">
        <div class=" col bg-primary text-center"><h1 class="text-white"> Credit Institute 11 <sup>th</sup> Class Student Attendence Details</h1>
        </div>
    ...
    <div class="col-md-4 mb-2 col-6 mt-3 mx-auto">
      <input type="submit"  class="form-control btn bg-primary" name="submit" value="Show Attendence"> 
        ...
        <div class="card-body mx-auto">
          <p class="card-text">
           ...
           $sql = "SELECT * FROM `class_11`,`attend_11` WHERE reg='$roll' AND roll='$roll' AND month='$month'";
