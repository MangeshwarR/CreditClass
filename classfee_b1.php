	...
	<div class="row mt-5 mb-5">
		<div class="col shadow-lg">
			 <div class="row mb-3">
			 	...
			 	<a href="feepayform_b1.php" class="btṇ bg-primary text-white ml-7 p-3 rounded-circle">Add New Student Fees</a>
			 </div>
			 </div>
 	...
 	<tr>
 	    ...
 	    <td>2020<a href="feepayformedit_b1.php?roll=<?php echo $data['roll'];?>" class="btṇ bg-primary text-white ml-4 p-1 rounded-circle">Edit</a></td>
 	</tr>
<?php
}
?>
