	...
	<div class="row">
		...
		<div class="col-md-8">
			<div class="card shadow-lg">
				<form class="form-group" action="feepayform_b1.php" method="post" enctype="multipart/form-data">
					<div class=" col bg-primary text-center"><h1 class="text-white"> Credit Institute B.Com 1 <sup>st</sup> Class Student Fees Details</h1>
        </div>
...
$query ="INSERT INTO `fees_b1`(`roll`, `name`, `month`, `dt`, `paid`, `dcount`, `unpaid`, `echarge`) VALUES ('$roll','$name','$month','$dt','$paid','$dcount','$unpaid','$echarge')";
...
if($run == TRUE)
 {
 	...
 	$roll=$_POST['roll'];
 	include 'conection.php';
$query = "SELECT * FROM `fees_b1` WHERE roll='$roll'";
$run = mysqli_query($conn,$query);
