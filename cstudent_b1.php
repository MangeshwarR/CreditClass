...
<body>
	...
	<div class="row mt-3 mb-5">
			 	<div class=" col bg-danger text-center fixed-top "><h1 class="text-white"> Credit Institute B.Com 1 <sup>st</sup> Class Student Detail</h1><a href="cstudentedit_b1.php" class="btṇ bg-primary text-white ml-7 p-3 rounded-circle">Add New Student</a></div>
 	...
 	<tr>
		<td colspan="2"><?php echo $data['reg'];?><a href="cstudentedit1_b1.php?cname=<?php echo $data['cname'];?>" class="btṇ bg-primary text-white ml-4 p-1 rounded-circle">Edit</a><a href="cstudentdeleteB1.php?reg=<?php echo $data['reg'];?>" class="btṇ bg-danger text-white ml-4 p-1 rounded-circle">Delete</a> </td>	 
