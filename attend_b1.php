...
<body>
	...
	<div class="row mt-5 mb-5">
		<div class="col shadow-lg">
			 <div class="row mb-3">
			 	<div class=" col bg-danger text-center"><h1 class="text-white"> Credit Institute B.Com 1 <sup>st</sup> Class Student Attend Detail</h1></a>
			 	</div>
			 </div>   
			 <div class="row ">
			<div class="col-md-4 mx-auto">
			   <h3><a href='attend1_b1.php' class="ml-5 btn btn-primary text-white">View All Student Attend Details</a></h3>
			 </div>
			 <div class="col-md-4 mx-auto">
			 	<h3><a href='classattend_b1.php' class="ml-5 btn btn-primary text-white">Add Student Attendence</a></h3>
			 	 </div>
			 	</div>                    
